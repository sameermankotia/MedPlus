...
<div class="card mt-3">
    ...
    @php
        if($attempt && $attempt->tests != null){
            $explode = explode(", ",$attempt->tests); 
        }else{
            $explode=[];
        }
    @endphp
    <form method="post" action="{{ route('quiz_test.post',$casestudies->id) }}">
        @csrf
        <div class="card-body">
            <div class="row">
                <div class="col-sm-8">
                ...
                <div class="col-sm-4">
                    <div class="card order_list">
                        ...
                        <div class="card-body">
                            ...
                            {{-- @else
                            <a class="btn btn-success mt-4" href="{{ route('results.get',$casestudies->id) }}">Next</a>
                            @endif --}}
                        </div>
                    </div>
