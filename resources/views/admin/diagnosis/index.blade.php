            ...
            <tbody>
                @foreach ($list as $data)
                    <tr>
                        ...
                        <td>
                            <form action="{{ route('diagnosis.destroy',$data->id) }}" method="Post">
                                <!-- Update -->
                                <a title="{{__('Update')}}" class="btn btn-outline-primary btn-sm" href="{{ route('diagnosis.edit',$data->id) }}"><i class="fa fa-pencil"></i></a>
                                <!-- End -->
                                @csrf
                                @method('DELETE')
